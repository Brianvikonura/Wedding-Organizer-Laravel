                    ...
                    <div class="col-lg-4">
                        <div class="card overflow-hidden">
                            <div class="card-body p-4 mb-5">
                                ...
                                <p class="text-dark me-1 fs-3 mb-0">{{ $totalCatalogues }} Katalog</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card overflow-hidden">
                            <div class="card-body p-4 mb-5">
                                ...
                                <p class="text-dark me-1 fs-3 mb-0">{{ $totalOrder }} Pemesanan</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card overflow-hidden">
                            <div class="card-body p-4 mb-5">
                                ...
                                <p class="text-dark me-1 fs-3 mb-0">{{ $totalUser }} User</p>
                            </div>
                        </div>
                    </div>
